## CAUTION
This build is a bitch. My OCD/aesthetic requires i design things to be as small as possible, sorry. I will probably update with a second, larger, through-hole PCB, or one that can be assembled for you by a fab, but this is it for now...
